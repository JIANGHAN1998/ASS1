        ...
        <div class="px-4 sm:px-6 mt-6">
          <div class="flex items-center justify-end">
            ...
            >
              ...
              <button class="btn-chip-blue" title="Options">⋮</button>
...
/** 隐藏州/国家等尾部信息（Victoria/VIC/NSW/Australia 等） */
  ...
  rows.forEach(s => {
    ...
    marker.bindPopup(`
      <div style="min-width:240px">
        ...
        <em style="color:#64748b">Loading address…</em><br/>
